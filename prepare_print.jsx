...
function logError(msg) {
    var f = new File("/Users/tarikhamzaucar/Desktop/Yeditepe Yacht /claude/ai_error.txt");
    f.open("a");
    f.writeln(msg);
    f.close();
}
...
function processPage(pageNum) {
    try {
        ...
        var pdfPath = "/Users/tarikhamzaucar/Desktop/Yeditepe Yacht /claude/temp_print.pdf";
        ...
        var outPath = "/Users/tarikhamzaucar/Desktop/Yeditepe Yacht /claude/index1_Baski_Hazir_Sayfa" + pageNum + ".pdf";
